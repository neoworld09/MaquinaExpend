...
## LEDs
set_property -dict { PACKAGE_PIN H17   IOSTANDARD LVCMOS33 } [get_ports { dinero_ingresado[0] }]; IO_L18P_T2_A24_15 Sch=dinero_ingresado[0]
set_property -dict { PACKAGE_PIN K15   IOSTANDARD LVCMOS33 } [get_ports { dinero_ingresado[1] }]; IO_L24P_T3_RS1_15 Sch=dinero_ingresado[1]
set_property -dict { PACKAGE_PIN J13   IOSTANDARD LVCMOS33 } [get_ports { dinero_ingresado[2] }]; IO_L17N_T2_A25_15 Sch=dinero_ingresado[2]
set_property -dict { PACKAGE_PIN R18   IOSTANDARD LVCMOS33 } [get_ports { verificacion_exitosa }]; IO_L7P_T1_D09_14 Sch=verificacion_exitosa
#set_property -dict { PACKAGE_PIN V17   IOSTANDARD LVCMOS33 } [get_ports { count[1] }]; IO_L18N_T2_A11_D27_14 Sch=count[1]
#set_property -dict { PACKAGE_PIN U17   IOSTANDARD LVCMOS33 } [get_ports { count[2] }]; #IO_L17P_T2_A14_D30_14 Sch=count[2]
...
## RGB LEDs
#set_property -dict { PACKAGE_PIN R12   IOSTANDARD LVCMOS33 } [get_ports { led }]; IO_L5P_T0_D06_14 Sch=led
...
##Buttons
#set_property -dict { PACKAGE_PIN N17   IOSTANDARD LVCMOS33 } [get_ports { btn }]; IO_L9P_T1_DQS_14 Sch=btn
#set_property -dict { PACKAGE_PIN M18   IOSTANDARD LVCMOS33 } [get_ports { btn_debounced }]; IO_L4N_T0_D05_14 Sch=btn_debounced
set_property -dict { PACKAGE_PIN P17   IOSTANDARD LVCMOS33 } [get_ports { reset }]; IO_L12P_T1_MRCC_14 Sch=reset
#set_property -dict { PACKAGE_PIN M17   IOSTANDARD LVCMOS33 } [get_ports { btn_ingreso }]; IO_L10N_T1_D15_14 Sch=btn_ingreso
set_property -dict { PACKAGE_PIN P18   IOSTANDARD LVCMOS33 } [get_ports { btn_verificar }]; IO_L9N_T1_DQS_D13_14 Sch=btn_verificar
...
##Pmod Header JC
set_property -dict { PACKAGE_PIN K1    IOSTANDARD LVCMOS33 } [get_ports { btn_ingreso }]; IO_L23N_T3_35 Sch=btn_ingreso
